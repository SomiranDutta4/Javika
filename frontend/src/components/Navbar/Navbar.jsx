...
const Navbar = ({ setShowLogin, setShowLoginSeller }) => {
        ...
        {!(user) ? <button className='signbutton' onClick={() => setShowLogin(true)}>sign in</button>
          : <div className='navbar-profile'>
            ...
            <ul className="nav-profile-dropdown">
              ...
              <li onClick={BecomeSeller}><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRrfSvr4eYqtozK-_cJjAqMKizbP5GprWYerg&s" alt="" /><p>Become A Seller</p></li>
            </ul>
          </div>}
      </div>
    </div>
